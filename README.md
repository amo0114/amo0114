...
<sub>**领域** &nbsp;|&nbsp; 后端开发 · 系统设计 · DevOps 工程化</sub><br/>
<sub>**关注** &nbsp;|&nbsp; 缓存策略 / 异步解耦 / 性能优化 / CI·CD 容器化交付</sub><br/>
<sub>**取向** &nbsp;|&nbsp; 把「能跑」写成「可观测、可恢复、可迭代」</sub>
...
<p>
  <b>Backend & Data / 核心支撑</b><br/>
  <img src="https://skillicons.dev/icons?i=java,spring,mysql,mongodb,redis,rabbitmq" alt="Backend and Data" />
</p>

<p>
  <b>DevOps & Tooling / 工程化底座</b><br/>
  <img src="https://skillicons.dev/icons?i=docker,nginx,linux,git,maven,idea" alt="DevOps and Tools" />
</p>

<p>
  <b>Frontend / 前端呈现</b><br/>
  <img src="https://skillicons.dev/icons?i=vue,ts" alt="Frontend" />
</p>
