...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&pause=1000&color=36BCF7&center=true&vCenter=true&width=600&lines=Full-stack+Java+Developer;Spring+Boot+Expert;System+Architect+in+Progress;2026+University+Graduate" alt="Typing SVG" />
</p>
...
- 💻 **专注领域**: 后端开发 / 分布式架构 / DevOps
- 🛠️ **近期项目**: 
  - 🏠 **House Rental Management System**: 基于 Spring Boot + Vue 的全栈项目
  - 🍲 **Foodie**: 基于位置服务的商户管理系统
  - 🤖 **MoGPT**: 仿 ChatGPT 界面的 AI 交互应用
- ✉️ **联系我**: [moyuan@oai-o.com]
